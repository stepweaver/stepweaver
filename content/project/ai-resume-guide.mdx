...
- Then, I gave it *my real story* — how I’ve used AI to build my projects, debug my code, and accelerate my learning.

That made the difference. The tone shifted from *"I know these tools"* to:  
> *“Here’s how I use them to get results.”*
