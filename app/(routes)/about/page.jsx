      ...
      <div className='space-y-4 p-4'>
        <div className='border-l-2 border-terminal-green pl-5'>
          ...
          <p className='text-terminal-text mt-4'>
            ...
            passion for web development and modern JavaScript frameworks. I
            don't just code—I engineer, refine, and optimize.
          </p>
          <p className='text-terminal-text mt-3'>
            Whether I&apos;m building full-stack applications, exploring DevOps
            automation, or pushing the boundaries of what&apos;s possible with
            new technologies, I thrive on learning, adapting, and solving
            complex problems.
          </p>
          <p className='text-terminal-text mt-3'>
