    ...
    <div className="space-y-1">
      {posts.map((post, index) => {
        ...
        return (
          ...
          >
            <div
              className={`py-2 px-3 rounded-sm ${isHovered ? `bg-${color}/10` : ''} hover:bg-${color}/10 transition-colors flex items-center`}
            ...
            >
              ...
              <div className="flex-grow truncate pr-4">
                <h3 className={`text-${color} text-sm md:text-base font-medium`}>
                  {post.title}
                </h3>
              ...
              <div className="flex flex-col items-end flex-shrink-0">
                <span className="text-terminal-dimmed text-xs">{formatDate(post.date)}</span>
                ...
                {post.hashtags && post.hashtags.length > 0 && (
                  <div className="flex space-x-1 mt-1">
                    ...
                    {post.hashtags.length > 2 && (
                      <span className="text-terminal-dimmed text-xs">+{post.hashtags.length - 2}</span>
                    )}
                  </div>
                )}
              </div>
